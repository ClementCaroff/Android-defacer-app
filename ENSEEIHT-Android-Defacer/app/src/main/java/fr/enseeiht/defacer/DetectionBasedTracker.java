...
public class DetectionBasedTracker
{
	...
	//**************************************
	public void deface(Mat image, MatOfRect faces) {
		nativeDeface(mNativeObj, image.getNativeObjAddr(), faces.getNativeObjAddr());
	}
	...
	//**************************************
	private static native void nativeDeface(long thiz, long image, long faces);
